...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initVilles() {
		Stream.of("Mahdia","Sousse","Monastir","Tunis","Sfax").forEach(villeInit->{
			Ville ville =new Ville();
			ville.setName(villeInit);
	...
	public void initCinema() {
		villeRepository.findAll().forEach(v->{
			Stream.of("Rigrama","Imax","Foundoun","Chahrazad","Daouliz")
			.forEach(nameCinema->{
	...
	Stream.of("action","horror","drama").forEach(c->{
	...
	public void initFilms() {
		...
		Stream.of("spiderman","fastandFurious","saw","ironMan","game of trones","catwomen",
				"la laigne verte").forEach(titreFilm->{
			Film film =new Film();
